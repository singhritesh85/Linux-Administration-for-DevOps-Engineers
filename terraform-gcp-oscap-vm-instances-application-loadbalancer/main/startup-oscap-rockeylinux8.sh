...
oscap xccdf eval --oval-results --profile cis --results-arf /tmp/arf.xml --report /tmp/report.html /usr/share/xml/scap/ssg/content/ssg-rl8-ds.xml
oscap xccdf generate fix --fix-type ansible --result-id "" --fetch-remote-resources /tmp/arf.xml > /opt/playbook-rockeylinux8.yml
