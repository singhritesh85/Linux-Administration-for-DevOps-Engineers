...
provide_ami = {
  ...
  "us-east-2-amazonlinux2023" = "ami-025ca978d4c1d9825"    ###"ami-0c803b171269e2d72"
  "us-east-2-rhel9" = "ami-0d7ccd295b85f91f7"
...
application_loadbalancer_name = "oscap"
internal = false
...
access_log_bucket = "s3bucketcapturealblogwebserver" ### S3 Bucket into which the Access Log will be captured
prefix_log = "application_loadbalancer_log_folder"
idle_timeout = 60
enabled = true
target_group_name = "oscap"
instance_port = 80
